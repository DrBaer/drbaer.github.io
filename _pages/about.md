...
:wave: Hi, I'm Lars. I'm a computer scientist fascinated by how machine learning can solve real-world problems (though honestly in many cases a linear method was enough).

My background is in computational biology and chemistry, but I've spent my career developing deep learning solutions — primarily for automated driving using point cloud data (atoms are also points, right?). This involved challenges like object detection, prediction, uncertainty estimation, and tracking. I also applied deep learning in the field of liquid biopsy, where I built a system for cell detection and tracking.
